...
class RestConnection{
    ...
    func MethodHTTPSecureImage(url: String, method: HTTPMethod, completion: @escaping (UIImage?, String?) -> () ){
        ...
        connectionLayer.conneccionRequest(url: url, method: method, headers: headers, parameters: nil) { (data, respString) in
    ...
    func MethodHTTPSecure(url: String,body: [String: Any], method: HTTPMethod, completion: @escaping (Data?, String?) -> () ){
        ...
        connectionLayer.conneccionRequest(url: url, method: method, headers: headers, parameters: body) { (data, respString) in
            guard let data = data else {
                completion(nil, respString)
                return
            }
